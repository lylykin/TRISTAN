...
class _MapPinInfoState extends State<MapPinInfo> {
  ...
  Widget build(BuildContext context) {
    return FilledButton(onPressed: _PinMapOverlayController.toggle,
    child: OverlayPortal( // Crée un widget flottant, déclanché si bind à un pin sur la carte
          ...
          return Positioned(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [ // Besoin de changer les couleurs du texte !
