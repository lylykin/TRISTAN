...
class MapPage extends StatefulWidget {
  final List stationList; // liste de tuples de la forme (lat : double, long : double, stationName : String)
...
class _MapPageState extends State<MapPage> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int stationIndex = 0; stationIndex < stationList.length; stationIndex++) {
      dynamic lat = stationList[stationIndex].lat;
      dynamic long = stationList[stationIndex].long;
      markersList.add(Marker( // Création d'un widget marker pour chaque instance de la liste en entrée de mappage
        width: 30,
        height: 30,
          ...
          onPressed: () {
            setState(() {
              if (selectedPinIndex != stationIndex) {
                ...
                pinOverlayController.show(); // Affichage de l'overlay (pin appuyé donc overlay non placeholder)
              } else {
    ...
    return OverlayPortal(
      ...
      overlayChildBuilder: (context) {
        ...
        final station = stationList[selectedPinIndex!]; // Considéré non null car test renvoyant un overlay vide si aucun pin séléctionné
        return Positioned(
          top: 50,
          left: 150,
          child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(station.stationName.toString(), style: TextStyle(fontWeight: FontWeight.bold),),
